...
// after each fight you can choose to leave or fight one more monster
// make toolbar with inventory icon, so it would be possible to open inventory and equip items or drink potions any time

// if you have weapon with plus slot effect and removing that weapon would make your slots disappear (inventory is full)
